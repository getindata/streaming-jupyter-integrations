...
class SQLSyntaxHighlighting:
    def __init__(self, magic_names: List[str], jupyter_dir):
    ...
    def __ensure_new_code_in_customjs(self):
        """
    ...
    def __ensure_customjs_exists(self):
        """
